...
## Generated on : Fri Jun 16 16:10:26 2017
...
INCLUDES_BUILDINFO = $(MATLAB_ROOT)\simulink\include\sf_runtime;$(START_DIR)\Parametric_ert_rtw;$(START_DIR);$(START_DIR)_done;$(MATLAB_ROOT)\extern\include;$(MATLAB_ROOT)\simulink\include;$(MATLAB_ROOT)\rtw\c\src;$(MATLAB_ROOT)\rtw\c\src\ext_mode\common;$(MATLAB_ROOT)\rtw\c\ert
...
DEFINES_STANDARD = -DMODEL=Parametric -DNUMST=2 -DNCSTATES=1 -DHAVESTDIO
...
SRCS = $(START_DIR)\Parametric_ert_rtw\Parametric.c

MAIN_SRC = $(START_DIR)\Parametric_ert_rtw\ert_main.c
...
{$(START_DIR)\Parametric_ert_rtw}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\Parametric_ert_rtw}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
