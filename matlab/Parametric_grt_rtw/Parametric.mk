###########################################################################
## Makefile generated for Simulink model 'Parametric'. 
## 
## Makefile     : Parametric.mk
## Generated on : Fri Jun 16 16:00:22 2017
## MATLAB Coder version: 3.1 (R2016a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\Parametric.exe
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:\Users\ebenera\bme\2016_17_osz\dipterv1\matlab
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = Parametric_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = Parametric_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\Parametric.exe
...
INCLUDES_BUILDINFO = $(MATLAB_ROOT)\simulink\include\sf_runtime;$(START_DIR)\Parametric_grt_rtw;$(START_DIR);$(START_DIR)_done;$(MATLAB_ROOT)\extern\include;$(MATLAB_ROOT)\simulink\include;$(MATLAB_ROOT)\rtw\c\src;$(MATLAB_ROOT)\rtw\c\src\ext_mode\common
...
DEFINES_STANDARD = -DMODEL=Parametric -DNUMST=2 -DNCSTATES=1 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\Parametric_grt_rtw\Parametric.c $(START_DIR)\Parametric_grt_rtw\Parametric_data.c $(START_DIR)\Parametric_grt_rtw\rtGetInf.c $(START_DIR)\Parametric_grt_rtw\rtGetNaN.c $(START_DIR)\Parametric_grt_rtw\rt_nonfinite.c rt_logging.c
...
OBJS = Parametric.obj Parametric_data.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_logging.obj
...
{$(START_DIR)\Parametric_grt_rtw}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\Parametric_grt_rtw}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
